...
Debug.ShouldStop(16);
 BA.debugLineNum = 38;BA.debugLine="xui.MsgboxAsync(\"servidor web ejecuntandose !!\",";
Debug.ShouldStop(32);
main._xui.runVoidMethod ("MsgboxAsync",main.processBA,(Object)(BA.ObjectToCharSequence("servidor web ejecuntandose !!")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("B4X"))));
 BA.debugLineNum = 39;BA.debugLine="StartService( ServidorWeb )";
Debug.ShouldStop(64);
main.mostCurrent.__c.runVoidMethod ("StartService",main.processBA,(Object)((main.mostCurrent._servidorweb.getObject())));
...
servidorweb_subs_0._process_globals();
main.myClass = BA.getDeviceClass ("b4a.example.main");
servidorweb.myClass = BA.getDeviceClass ("b4a.example.servidorweb");
